...
Partial Class Portf
    ...
    '<div Class="span3 company"><a href = "portfolio-single.html" Class="work"><img src = "img/content/portfolio-1.jpg" width="370" height="270" alt=""><span Class="shadow"></span><div Class="bg-hover"></div><div Class="work-title"><h3 Class="title">Morbi non lacus ac sapien molestie</h3><div Class="description">وب سایت شرکتی</div></div></a></div>
            ...
            For Each q In qryMenu
                ...
                ElseIf q.HasSub = True And q.IDSM = 0 And q.MegaMenu = True Then
                    ...
                    For Each k In qryMegaMenu
                        Item.Text += "<li class='parent megamenu'><a href='" + q.Href + "'>" + q.Name_Fa + "</a><ul class='sub'><li class='promo-block box'><a href='" + k.Href.ToLower() + "' class='big-image'><img src='" + k.Image + "' width='240' height='434' alt='" + q.Alt_Fa + "'></a></li>"
            ...
            Try
                ...
                For Each Portf In Portfolio
                    ...
                    For Each catelink In Portf.CatName_En.Split(";")
                        ...
                        Exit For
                    Next
                    MetaIMG = "<meta property='og:image' content='/Uploads/Content/Portfolios/narem.ir/Home.PNG' />"
