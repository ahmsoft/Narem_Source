...
Partial Class Inbox
    ...
    '                  Select m Where m.IDClient = Convert.ToInt32(CommentView.SelectedValue)
    '        For Each q In qry
    ...
    '        'MsgBox(Session("IDCli"))
    '        Dim db = New LinqDBClassesDataContext
    '        Dim Client = From m In db.Clients
    '                     Select m Where m.IDClient = Convert.ToDouble(stridclient)
    ...
    '                    Select m Where m.IDO = Convert.ToDouble(CurentIDO)
    '        For Each m In Order
    ...
    '            Dim qry = From m In db.Comments
    '                      Select m
    '                      Where m.IDC = Convert.ToInt32(Request.QueryString("ID").ToString)
    '            For Each q In qry
