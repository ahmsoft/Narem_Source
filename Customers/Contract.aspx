<%@ Page Title="" Language="VB" MasterPageFile="~/Customers/CustomersMasterPage.master" AutoEventWireup="false" CodeFile="Contract.aspx.vb" Inherits="Customers_Contract" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="box box-primary" runat="server" id="frmCustomersInfo">
