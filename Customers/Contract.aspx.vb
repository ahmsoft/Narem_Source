...
Partial Class Customers_Contract
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            Dim Customers = From m In db.Users
                         Select m Where m.Username = Convert.ToInt32(stridclient)
            For Each m In Customers
            ...
            'Select m Where m.IDC = Convert.ToInt32(stridclient) Order By m.IDC Descending
            'Where m.IDCustomers = IDCustomers 
