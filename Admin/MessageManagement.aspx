<%@ Page Title="" Language="VB" MasterPageFile="AdminMasterPage.master" AutoEventWireup="true" CodeFile="MessageManagement.aspx.vb" Inherits="MessageManagement" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6">
                            ...
                            <div class="col-lg-12">
                                <asp:TextBox runat="server" for="Text" ID="txtCatName_En" Style="margin-bottom: 10px;" class="form-control" placeholder="نام دسته انگلیسی" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <asp:TextBox runat="server" for="Text" ID="txtCatDescription_En" Style="text-align:left;direction:ltr; margin-bottom: 15px;" class="form-control" placeholder="توضیح انگلیسی" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="box box-default" id="Posts">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <asp:Button runat="server" ID="btnShowAll" type="button" class="btn btn-box-tool" data-widget="" Text="نمایش تمام پست‌ها" />
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <asp:GridView ID="MessageView" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="DataSourceMessage" Width="100%" DataKeyNames="IDMessage">
                                <Columns>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <asp:SqlDataSource ID="DataSourceMessage" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" SelectCommand="SELECT * FROM [Message] WHERE CatName_Fa LIKE '%' + @CatName + '%' ORDER BY Year_En DESC, Month_En DESC, Day_En DESC, Priority DESC, IDMessage DESC" DeleteCommand="Delete From [Message] Where [IDMessage]=@IDMessage">
                        <DeleteParameters>
                            <asp:ControlParameter ControlID="MessageView" Name="IDMessage" PropertyName="SelectedValue" />
                        </DeleteParameters>
                    ...
                    <div class="box box-warning" id="MessageInfo">
                        <div class="box-header with-border">
                            <h3 class="box-title"><a href="#" style="color: black;" data-widget="collapse">اطلاعات پیام</a></h3>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12 center-block">
                                        <asp:CheckBox ID="CheckBoxIsShow" Style="margin-bottom: 30px;" CssClass="col-xs-12 checkbox" runat="server" Text="پیام نمایش داده شود." Checked="True" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="box box-success" id="Message_Fa">
                <div class="box-header with-border">
                    <h3 class="box-title"><a href="#" style="color: black;" data-widget="collapse">پیام فارسی</a></h3>
                    <div class="box-tools pull-right">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-12 center-block">
                                <label for="RadPreMessage_Fa" class=" control-label">مطلب به فارسی:</label>
                            </div>
                            <div class="col-lg-12 center-block">
                                <telerik:RadEditor ID="RadPreMessage_Fa" runat="server" Skin="Bootstrap" Style="direction: ltr; margin-bottom: 30px; height: auto;" Width="100%" ToolbarMode="Floating" DocumentManager-ViewPaths="~/Uploads" ImageManager-ViewPaths="~/Uploads"></telerik:RadEditor>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-12 center-block">
                                <label for="RadMessage_Fa" class=" control-label">ادامه مطلب به فارسی:</label>
                            </div>
                            <div class="col-lg-12 center-block">
                                <telerik:RadEditor ID="RadMessage_Fa" runat="server" Skin="Bootstrap" Style="direction: ltr; margin-bottom: 30px; height: auto;" Width="100%" ToolbarMode="Floating"></telerik:RadEditor>
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="box box-info" id="Message_En">
                <div class="box-header with-border">
                    <h3 class="box-title"><a href="#" style="color: black;" data-widget="collapse">پیام انگلیسی</a></h3>

                    <div class="box-tools pull-right">
                        <%--<a href="#Message_Fa" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-up"></i></a>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-12 center-block">
                                <label for="RadPreMessage_En" class=" control-label">مطلب به انگلیسی:</label>
                            </div>
                            <div class="col-lg-12 center-block">
                                <telerik:RadEditor ID="RadPreMessage_En" runat="server" Skin="Bootstrap" Style="direction: ltr; margin-bottom: 30px; height: auto;" Width="100%" ToolbarMode="Floating"></telerik:RadEditor>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-12 center-block">
                                <label for="RadMessage_En" class=" control-label">ادامه مطلب به انگلیسی:</label>
                            </div>
                            <div class="col-lg-12 center-block">
                                <telerik:RadEditor ID="RadMessage_En" runat="server" Skin="Bootstrap" Style="direction: ltr; margin-bottom: 30px; height: auto;" Width="100%" ToolbarMode="Floating"></telerik:RadEditor>
                            </div>
                        </div>
                    </div>
                    <div class="row">
