...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="DataSourceOrder" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" SelectCommand="SELECT * FROM [Order]" DeleteCommand="DELETE FROM [Order] Where [IDO]=@IDO
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtNameAndFamily" placeholder="به عنوان مثال: علی زاهدی" runat="server" type="Text" class="form-control" data-inputmask='"mask": ""' data-mask />
                        </div>
                        <!-- /.form-group -->
                        <br />
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtTel" placeholder="به عنوان مثال: 05123456789" runat="server" type="text" class="form-control" data-inputmask='"mask": "09999999999"' data-mask />
                        </div>
                        <br />
                        <!-- /.input group -->
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtMobile" placeholder="به عنوان مثال: 09301234567" runat="server" type="text" class="form-control" data-inputmask='"mask": "09999999999"' data-mask />
                        </div>
                        <!-- /.form-group -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtEmail" placeholder="به عنوان مثال: youremail@gmail.com" runat="server" type="Email" class="form-control" data-inputmask='"mask": ""' data-mask />
                        </div>
                        <!-- /.form-group -->
                        <br />
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtNameFa" placeholder="به عنوان مثال: آتریا" runat="server" type="text" class="form-control" data-inputmask='"mask": ""' data-mask />
                        </div>
                        <br />
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtNameEn" placeholder="به عنوان مثال: Atriya" runat="server" type="text" class="form-control" data-inputmask='"mask": ""' data-mask />
                        </div>
                        <br />
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtUsername" placeholder="نام کاربری به عنوان مثال: yourmail@gmail.com" runat="server" type="text" class="form-control" />
                        </div>
                        <!-- /.form-group -->
                        <br />
                        <!-- /.input group -->
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- /.form-group -->
                        <br />
                        <asp:SqlDataSource ID="DataSourceClient" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" SelectCommand="SELECT * FROM [Client] WHERE ([IDO] = @IDO)" DeleteCommand="DELETE FROM Client WHERE IDClient=@IDClient">
                            <DeleteParameters>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-12">
                            <asp:SqlDataSource ID="ContractSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" ProviderName="<%$ ConnectionStrings:NaremDBConnectionString.ProviderName %>" SelectCommand="SELECT * FROM Contract WHERE (IDO = @IDO)">
                                <SelectParameters>
