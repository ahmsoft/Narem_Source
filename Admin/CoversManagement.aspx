<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="CoversManagement.aspx.vb" Inherits="Admin_CoversManagement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">مدیریت آلبوم <small>مدیریت جلدها و آلبوم‌ها</small></h1>

                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i>Dashboard
                        </li>
                        <li class="active"><i class="fa fa-bank"></i>Cover Management
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="box box-success" id="Covers">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <%--<a href="#CoverStatus" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-down"></i></a>--%>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <asp:GridView ID="CoversView" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSourceCovers" Width="100%" DataKeyNames="IDCover">
                                <Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceCovers" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" SelectCommand="SELECT * FROM [Covers] ORDER BY [IDCover] DESC, [Title_Fa]" DeleteCommand="DELETE FROM [Covers] WHERE [IDCover]=@IDCover">
                                <DeleteParameters>
                                    <asp:Parameter Name="IDCover" />
                                </DeleteParameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
                    <%--<div class="row">
                        <div class="col-lg-12">
                            <asp:Label runat="server" ID="lblShowCover" Style="width: 100%;" Visible="false" />
                        </div>
                    </div>--%>
                </div>
            </div>
            <div class="box box-warning" id="CoverStatus">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <%--<a href="#Covers" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-up"></i></a>
                        <a href="#CoverInfoFa" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-down"></i></a>--%>
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                <!-- /.box-header -->
            ...
            <div class="box box-success" id="CoverInfo_Fa">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <%--<a href="#CoverStatus" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-up"></i></a>
                        <a href="#CoverInfo_En" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-down"></i></a>--%>
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                <!-- /.box-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtTitle_Fa" placeholder="عنوان جلد به فارسی" class="form-control" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>محل فارسی:</label>
                                <asp:TextBox runat="server" ID="txtLocation_Fa" placeholder="محل تصویر گرفته شده به فارسی"  class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtTitle_En" style="direction: ltr;text-align:left;" placeholder="عنوان جلد به انگلیسی" class="form-control" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>محل انگلیسی:</label>
                                <asp:TextBox runat="server" ID="txtLocation_En" style="direction: ltr;text-align:left;" placeholder="محل تصویر گرفته شده به انگلیسی" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="col-lg-12" id="Save">
                <div class="form-group">
                    <asp:Button ID="btnUpdateCover" runat="server" class="col-xs-6 btn btn-default" Text="ذخیره تغییرات" />
                    <asp:Button ID="btnSaveNewCover" runat="server" class="col-xs-6 btn btn-primary" Text="ایجاد جلد جدید" />
                </div>
