...
Partial Class Admin_BlockManagement
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim lblActive As System.Web.UI.HtmlControls.HtmlGenericControl = (Master.FindControl("menuLIBlocks"))
        lblActive.Attributes("Class") = "treeview active"
    End Sub
    Protected Sub BlockView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles BlockView.SelectedIndexChanged
        Try
            Dim db = New LinqDBClassesDataContext
            Dim qry = From m In db.Blocks
                      Select m
                      Where m.IDB = Convert.ToInt32(BlockView.SelectedValue)
            For Each q In qry
                txtBlockName_Fa.Text = q.Name_Fa
                txtBlockName_En.Text = q.Name_En
                'txtBlockNameFr.Text = q.NameFr
                'txtBlockNameAr.Text = q.NameAr
                txtPriorityBlock.Text = q.Priority

                'drpPosition.SelectedValue = q.Position
        ...
        End Try
    End Sub
    Protected Sub btnSaveNewCate_Click(sender As Object, e As EventArgs) Handles btnSaveNewBlock.Click
        Try
            Dim db = New LinqDBClassesDataContext
            Dim q = New Block
            q.Name_Fa = txtBlockName_Fa.Text
            q.Name_En = txtBlockName_En.Text
            'q.NameFr = txtBlockNameFr.Text
            'q.NameAr = txtBlockNameAr.Text
            q.Description_Fa = q.Name_Fa
            q.Description_En = q.Name_En
            'q.DescriptionFr = q.NameFr
            'q.DescriptionAr = q.NameAr
            'q.Position = drpPosition.SelectedValue.ToString()
            q.Position = "Right"
            q.Priority = txtPriorityBlock.Text
            db.Blocks.InsertOnSubmit(q)
            db.SubmitChanges()
            BlockView.DataBind()
            'drpBlock.DataBind()
        Catch ex As Exception
        ...
        End Try
    End Sub
    Protected Sub btnUpdateBlock_Click(sender As Object, e As EventArgs) Handles btnUpdateBlock.Click
        Try
            Dim db = New LinqDBClassesDataContext
            Dim qry = From m In db.Blocks
                      Select m Where m.IDB = Convert.ToInt32(BlockView.SelectedValue)
            For Each q In qry
                q.Name_Fa = txtBlockName_Fa.Text
                q.Name_En = txtBlockName_En.Text
                'q.NameFr = txtBlockNameFr.Text
