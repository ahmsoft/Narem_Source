...
Partial Class Admin_MenuManagement
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim lblActive As System.Web.UI.HtmlControls.HtmlGenericControl = (Master.FindControl("menuMenu"))
        lblActive.Attributes("Class") = "treeview active"
    End Sub
    Protected Sub MenuView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles MenuView.SelectedIndexChanged
        Try
            Dim db = New LinqDBClassesDataContext
            Dim qry = From m In db.Menus
                      Select m
                      Where m.IDM = Convert.ToInt32(MenuView.SelectedValue)
            For Each q In qry
                ...
                txtHref.Text = q.Href
                drpHasSub.SelectedValue = q.HasSub
                drpLinkTarget.SelectedValue = q.Target
                drpMega.SelectedValue = q.MegaMenu
                drpShow.SelectedValue = q.IsShow
        ...
        End Try
    End Sub
    Protected Sub btnSaveNewCate_Click(sender As Object, e As EventArgs) Handles btnSaveNewMenu.Click
        Try
            Dim db = New LinqDBClassesDataContext
            Dim q = New Menu
            ...
            q.Href = txtHref.Text
            q.HasSub = drpHasSub.SelectedValue
            q.Target = drpLinkTarget.SelectedValue
            q.MegaMenu = drpMega.SelectedValue
            q.IsShow = drpShow.SelectedValue
            q.Priority = txtPriority.Text
            db.Menus.InsertOnSubmit(q)
            db.SubmitChanges()
            MenuView.DataBind()
            'drpMenu.DataBind()
        Catch ex As Exception
        ...
        End Try
    End Sub
    Protected Sub btnUpdateMenu_Click(sender As Object, e As EventArgs) Handles btnUpdateMenu.Click
        Try
            Dim db = New LinqDBClassesDataContext
            Dim qry = From m In db.Menus
                      Select m Where m.IDM = Convert.ToInt32(MenuView.SelectedValue)
            For Each q In qry
                q.Name_Fa = txtName_Fa.Text
                q.Name_En = txtName_En.Text
                q.Alt_Fa = txtAlt_Fa.Text
