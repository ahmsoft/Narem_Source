Partial Class Admin_GalleryManagement
    ...
    '                lblAdminImage2.Text = "<div style='overflow: hidden;max-height:100px;'><img src='/" + m.PhotoMin + "' class='user-image' style='z-index: 5;width:100%;height:300px;border-radius: 50%;' alt='User Image' /></div>"
    '                lblAdminImage1.Text = "<div style=' overflow: hidden;max-height:27px;'><img src='/" + m.PhotoMin + "' class='user-image' style='width: 65px;max-width: 100px;height: 80px;' alt='User Image' /></div>"
    '                lblAdminImage.Text = "<div style='overflow: hidden;max-height:80px;'><img src='/" + m.PhotoMin + "' class='user-image' style='width: 100%;max-width: 70px;height: auto; border-radius: 50%;margin-right:-6px;' alt='User Image' /></div>"
    '                lblAdminNameFamily.Text = "<p>" + m.Name_Fa + " " + m.Family_Fa + "</p>"
    '                lblAdminNameFamily1.Text = "<span class='hidden-xs'>" + m.Name_Fa + " " + m.Family_Fa + "</span>"
    ...
    '                      Select m Where m.Seen = "جدید" Order By m.IDComment
    ...
    '    Dim lblActiveParent As System.Web.UI.HtmlControls.HtmlGenericControl = (Master.FindControl("menuLIGallerys"))
    '    lblActiveParent.Attributes("Class") = "treeview active"
    '    Dim lblActive As System.Web.UI.HtmlControls.HtmlGenericControl = (Master.FindControl("menuLIGallery"))
    '    lblActive.Attributes("Class") = "treeview active"
    'End Sub
    'Protected Sub GallerysView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GallerysView.SelectedIndexChanged
    '    Try
    '        Dim db = New LinqDBClassesDataContext
    '        Dim qry = From m In db.Galleries
    '                  Select m
    '                  Where m.IDG = Convert.ToInt32(GallerysView.SelectedValue)
    '        For Each q In qry
    '            txtName_Fa.Text = q.Name_Fa
    '            txtName_En.Text = q.Name_En
    '            txtNameFr.Text = q.NameFr
    '            txtNameAr.Text = q.NameAr
    '            RadGalleryDescription_Fa.Content = q.Description_Fa
    '            RadGalleryDescription_En.Content = q.Description_En
    '            RadGalleryDescriptionFr.Content = q.DescriptionFr
    '            RadGalleryDescriptionAr.Content = q.DescriptionAr
    ...
    '            txtLocation_En.Text = q.Location_En
    '            txtLocation_Fa.Text = q.Location_Fa
    '            txtLocationAr.Text = q.LocationAr
    '            txtLocationFr.Text = q.LocationFr
    ...
    '        Dim db = New LinqDBClassesDataContext
    '        Dim qry = From m In db.Galleries
    '                  Select m Where m.IDG = Convert.ToInt32(GallerysView.SelectedValue)
    '        For Each q In qry
    ...
    '            q.Location_Fa = txtLocation_Fa.Text
    '            q.Location_En = txtLocation_En.Text
    ...
    '        q.Location_Fa = txtLocation_Fa.Text
    '        q.Location_En = txtLocation_En.Text
    '        q.IDCover=CoverDropDownList.SelectedValue
    '        'q.Keyword_Fa = txtKeyword_Fa.Text
    '        'q.Keyword_En = txtKeyword_En.Text
    '        q.Moment_Fa = tarikh.Value
    '        db.Galleries.InsertOnSubmit(q)
    '        db.SubmitChanges()
    '        GallerysView.DataBind()
    '    Catch ex As Exception
    '        Response.Write(ex.Message)
