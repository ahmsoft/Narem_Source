...
Partial Class Admin_CoversManagement
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim lblActive As System.Web.UI.HtmlControls.HtmlGenericControl = (Master.FindControl("menuLICovers"))
        lblActive.Attributes("Class") = "treeview active"
    End Sub
    Protected Sub CoversView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CoversView.SelectedIndexChanged
        Try
            Dim db = New LinqDBClassesDataContext
            Dim qry = From m In db.Covers
                      Select m
                      Where m.IDCover = Convert.ToInt32(CoversView.SelectedValue)
            For Each q In qry
                txtTitle_Fa.Text = q.Title_Fa
                txtTitle_En.Text = q.Title_En
                'txtTitleFr.Text = q.TitleFr
                'txtTitleAr.Text = q.TitleAr
                RadCoverDescription_Fa.Content = q.Description_Fa
                RadCoverDescription_En.Content = q.Description_En
                'RadCoverDescriptionFr.Content = q.DescriptionFr
                'RadCoverDescriptionAr.Content = q.DescriptionAr
                ...
                'lblShowCover.Visible = True
                txtAddress.Visible = True
                'lblShowCover.Text = "<img src='" + q.Address + "' style='width:50%;height:auto;' />"
        ...
        End Try
    End Sub
    Protected Sub btnInsertImageBody_Fa_Click(sender As Object, e As EventArgs) Handles btnInsertImageCoverDescription_Fa.Click
    ...
    End Sub
    Protected Sub btnInsertImageBody_En_Click(sender As Object, e As EventArgs) Handles btnInsertImageCoverDescription_En.Click
    ...
    End Sub
    Protected Sub btnUpdateCover_Click(sender As Object, e As EventArgs) Handles btnUpdateCover.Click
        'Try
        '    Dim db = New LinqDBClassesDataContext
        '    Dim qry = From m In db.Covers
        '              Select m Where m.IDCover = Convert.ToInt32(CoversView.SelectedValue)
        '    For Each q In qry
        ...
        '        'q.TitleFr = txtTitleFr.Text
        '        'q.TitleAr = txtTitleAr.Text
        '        'q.DescriptionFr = RadCoverDescriptionFr.Content
        '        'q.DescriptionAr = RadCoverDescriptionAr.Content
        '        'q.LocationFr = txtLocationFr.Text
        '        'q.LocationAr = txtLocationAr.Text
        ...
        'End Try
    End Sub
    Protected Sub btnSaveNewCover_Click(sender As Object, e As EventArgs) Handles btnSaveNewCover.Click
        'Try
        '    Dim db = New LinqDBClassesDataContext
        '    Dim q = New Cover
        '    q.Title_Fa = txtTitle_Fa.Text
    ...
    Private Sub Admin_CoversManagement_InitComplete(sender As Object, e As EventArgs) Handles Me.InitComplete
        txtMoment_En.Value = Date_En()
    End Sub
