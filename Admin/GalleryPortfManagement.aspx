<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="GalleryPortfManagement.aspx.vb" Inherits="Admin_GalleryPortfManagement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="box box-success" id="PortfolioGallerys">
                <div class="box-header with-border">
                    <h3 class="box-title"><a href="#" style="color: black;" data-widget="collapse">جلد نمونه کار:</a>
                    </h3>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-title"><a href="#" style="color: black;" data-widget="collapse">تصاویر مربوط به جلد نمونه کار:</a>
                    </h4>
                            <asp:GridView ID="PortfolioGallerysView" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSourcePortfolioGallerys" Width="100%" DataKeyNames="IDPG">
                                <Columns>
                                    <asp:CommandField ButtonType="Button" SelectText="انتخاب" ShowSelectButton="True">
                                        <ControlStyle CssClass="btn btn-success btn-xs" Width="100%" />
                                    </asp:CommandField>
                                    ...
                                    <asp:TemplateField HeaderText="تصویر">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("SRC") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <a runat="server" id="imgz" href='<%# Bind("SRC") %>'>
                                                <center><asp:Image ID='Image1' Style='width: 43px; height: 23px;' class='img-responsive text-center' runat='server' ImageUrl='<%# Bind("SRC") %>' /></center>
                                            </a>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="text-center" />
                                        <HeaderStyle CssClass="text-center" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSourcePortfolioGallerys" runat="server" ConnectionString="<%$ ConnectionStrings:NaremDBConnectionString %>" SelectCommand="SELECT * FROM [PortfolioGallery] WHERE IDP=@IDP ORDER BY [IDPG] DESC, [Name_Fa]" DeleteCommand="DELETE FROM [PortfolioGallery] WHERE [IDPG]=@IDPG">
                                <DeleteParameters>
                                    <asp:Parameter Name="IDPG" />
                                </DeleteParameters>
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="CoversViewPortf" Name="IDP" PropertyName="SelectedValue" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-12 center-block">
                                <label for="txtAddress" class=" control-label">تصویر:</label><span>(855*624)px</span>
                            </div>
                            <div class="col-lg-12 center-block">
                                <asp:TextBox runat="server" for="Text" ID="txtAddress" Style="margin-bottom: 30px;" class="form-control" placeholder="آدرس تصویر پیام" />
                            </div>
                        </div>
                    </div>
                    <%--<div class="row">
...
<%--                        <a href="#GalleryStatus" type="button" class="btn btn-box-tool" data-widget=""><i style="color: blue;" class="fa fa-arrow-circle-up"></i></a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>آلت تصویر:</label>
                                <asp:TextBox runat="server" ID="txtALT_Fa" placeholder="آلت تصویر به فارسی" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="btn-group col-lg-12">
                                ...
                                <asp:TextBox runat="server" ID="FileNameGalleryDescription_Fa" PlaceHolder="آدرس تصویر در هاست" Style="width: 135px; height: 28px; direction: ltr;" />
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtName_En" placeholder="نام تصویر به انگلیسی" class="form-control" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>آلت انگلیسی:</label>
                                <asp:TextBox runat="server" ID="txtALT_En" placeholder="آلت تصویر به انگلیسی" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="btn-group col-lg-12">
                                ...
                                <asp:TextBox runat="server" ID="FileNameGalleryDescription_En" PlaceHolder="آدرس تصویر در هاست" Style="width: 135px; height: 28px; direction: ltr;" />
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 center-block">
                                <asp:TextBox ID="txtKeyword_En" Style="margin-bottom: 30px;" class="form-control" placeholder="کلمات کلیدی را با ; جدا کنید." runat="server" Width="100%" />
                            </div>
                        </div>
                    </div>
                </div>
