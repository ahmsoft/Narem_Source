        ...
        <small>دریافت اطلاعات لازم برای طراحی وب سایت</small>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="rdoNewDesign" runat="server" class="form-control select2 text-right" style="width: 100%;">
                ...
                <table style="width: 100%;">
                    <tr>
                        <th class="ali">
                            <center>
                                <asp:Label runat="server" ID="lblSubmitStatus" Text="پس از ارسال درخواست سفارش منتظر تماس کارشناس شرکت ما باشید. " /></center>
                        </th>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td>
                            <center>
                                <telerik:RadCaptcha ID="RadCaptcha" runat="server" CaptchaTextBoxCssClass="aligncenter" Font-Names="arial" Font-Bold="true" CaptchaImage-ImageCssClass="aligncenter " CaptchaTextBoxLabel=""></telerik:RadCaptcha>
                            </center>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <center><strong style="color: orangered;">توجه:</strong> بارگذاری مجدد تصویر امنیتی Ctrl + R</center>

                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button runat="server" type="submit" Style="width: 100%; height: 45px; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;" name="submit" ID="btnSubmit" Text="ارسال" class="btn btn-block btn-primary" />
                        </td>
                    </tr>
                </table>
